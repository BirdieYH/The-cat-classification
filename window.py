...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('猫咪分类')  # todo 修改系统名称
        # 模型初始化

        self.model = tf.keras.models.load_model("models/cats_cnn.h5")  # todo 修改模型名称
        self.to_predict_name = "images/panda.jpg"  # todo 修改初始图片，这个图片要放在images目录下
        self.class_names = ["亚洲豹猫", "加拿大无毛猫", "布偶猫", "暹罗猫", "橘猫", "熊猫", "狸花猫", "美国短毛猫", "英国短毛猫"]  # todo 修改类名，这个数组在模型训练的开始会输出
        self.resize(900, 700)
        self.initUI()
    ...
    def initUI(self):
        ...
        about_title = QLabel('niko')  # todo 修改欢迎词语
        about_title.setFont(QFont('楷体', 18))
        about_title.setAlignment(Qt.AlignCenter)
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/panda.jpg'))
